...
proc create_hier_cell_filter { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fir_dma_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins fir_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net fir_dma_M_AXI_S2MM [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins fir_dma/M_AXI_S2MM]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins aclk] [get_bd_pins fir/aclk] [get_bd_pins fir_dma/m_axi_mm2s_aclk] [get_bd_pins fir_dma/m_axi_s2mm_aclk] [get_bd_pins fir_dma/s_axi_lite_aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net fir_dma_M_AXI_MM2S [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins filter/M_AXI_MM2S]
  connect_bd_intf_net -intf_net fir_dma_M_AXI_S2MM [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins filter/M_AXI_S2MM]
