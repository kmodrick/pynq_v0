...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_i2s_adi_0/S00_AXI] [get_bd_intf_pins axi_smc/M01_AXI]
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axi_i2s_adi_0/S_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net dds_compiler_0_M_AXIS_DATA [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins dds_compiler_0/M_AXIS_DATA]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_i2s_adi_0/S_AXIS_ACLK] [get_bd_pins axi_i2s_adi_0/s00_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins filter/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_i2s_adi_0/s00_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins filter/aresetn] [get_bd_pins filter/axi_resetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_ports pmodJA] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_i2s_adi_0/SDATA_I] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_i2s_adi_0/S00_AXI/S00_AXI_reg] SEG_axi_i2s_adi_0_S00_AXI_reg
