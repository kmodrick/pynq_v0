...
kratos.us:user:generate_DV:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: generate_DV_0, and set properties
  set generate_DV_0 [ create_bd_cell -type ip -vlnv kratos.us:user:generate_DV:1.0 generate_DV_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_fifo_mm_s_0/S_AXI] [get_bd_intf_pins axi_smc/M01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_fifo_mm_s_0/S_AXI_FULL] [get_bd_intf_pins axi_smc/M00_AXI]
  ...
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tdata [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tdata] [get_bd_pins split_LR_data_0/DataIn]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tvalid [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tvalid] [get_bd_pins pmod_I2S_0/DataValid]
  connect_bd_net -net generate_DV_0_DVOut [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tready] [get_bd_pins generate_DV_0/DVOut]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins generate_DV_0/AxiClk] [get_bd_pins generate_DV_0/ClkIn] [get_bd_pins pmod_I2S_0/ClkIn] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
