...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins pmod_I2S_0/LeftData] [get_bd_pins pmod_I2S_0/RightData]
  connect_bd_net -net dds_compiler_0_m_axis_data_tvalid [get_bd_pins dds_compiler_0/m_axis_data_tvalid] [get_bd_pins pmod_I2S_0/DataValid]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins dds_compiler_0/aclk] [get_bd_pins pmod_I2S_0/ClkIn] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
